<div id="carousel-sample" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" alt="" src="{{asset('images/about1.jpg')}}"  />
        </div>
        <div class="carousel-item active">
            <img class="d-block w-100" alt="" src="{{asset('images/about2.jpg')}}"  />
        </div>
        <div class="carousel-item active">
            <img class="d-block w-100" alt="" src="{{asset('images/about3.jpg')}}"  />
        </div>
